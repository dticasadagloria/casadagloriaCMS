        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Preenche os dados do visitante
            </p>
          </div>
          <button
            onClick={onFechar}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Toggle
              ...
              value={form.externo}
              onChange={() =>
                setForm((prev) => ({ ...prev, externo: !prev.externo }))
              }
              cor="amber"
            />
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Field label="Escola da Verdade">
              <select
                value={form.escola_da_verdade}
                onChange={set("escola_da_verdade")}
                className={inputClass}
              >
            ...
            <Toggle
              ...
              value={form.batizado}
              onChange={() =>
                setForm((prev) => ({ ...prev, batizado: !prev.batizado }))
              }
              cor="emerald"
            />
          </div>
        ...
        {[
          {
            ...
            value: relatorio?.stats?.total ?? 0,
            cor: "slate",
            filtro: "todos",
          },
          {
            label: "Externos",
            value: relatorio?.stats?.externos ?? 0,
            cor: "amber",
            filtro: "externos",
          },
          {
            label: "Internos",
            value: relatorio?.stats?.internos ?? 0,
            cor: "sky",
            filtro: "internos",
          },
          {
            label: "Convertidos",
            value: relatorio?.stats?.convertidos ?? 0,
            cor: "emerald",
            filtro: "convertidos",
          },
          ...
          <button
            key={label}
            onClick={() =>
              setFiltroTipo(filtro === filtroTipo ? "todos" : filtro)
            }
                ...
                {visitantesFiltrados.length === 0 ? (
                  ...
                  visitantesFiltrados.map((v, i) => (
                    ...
                    >
                      ...
                      {/* <td className="px-4 py-3.5 text-[13px] text-slate-600">{v.faixa_etaria ?? "—"}</td> */}
                      <td className="px-4 py-3.5 text-[13px] text-slate-600">
                        {v.contacto ?? "—"}
                      </td>
                      <td className="px-4 py-3.5 text-[13px] text-slate-600">
