...
const Dashboard = () => {
  ...
  const PERMISSOES = {
    ...
    departamentos: [ROLES.ADMIN, ROLES.PASTOR, ROLES.IICGPMAXIXE, ROLES.IICGPALBAZINE, ROLES.IICGPSEDE],
    estatistica: [
      ROLES.ADMIN,
      ROLES.PASTOR,
      ROLES.ESTATISTICA,
    ...
    cultos: [ROLES.ADMIN, ROLES.ESTATISTICA, ROLES.MEMBROSESTATISTICA, ROLES.IICGPMAXIXE, ROLES.IICGPALBAZINE, ROLES.IICGPSEDE],
    visitas: [ROLES.ADMIN, ROLES.ESTATISTICA, ROLES.MEMBROSESTATISTICA, ROLES.IICGPMAXIXE, ROLES.IICGPALBAZINE, ROLES.IICGPSEDE,],
